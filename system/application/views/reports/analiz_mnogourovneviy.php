...
$buf_sum_otp_nds=($buf_vsego_kvt)*17.92;
...
<td>
 ...
 <th align=right>
  <b><?php echo f_d($vsego_kvt*17.92);?></b>
 </th>
 <th align=right>
  <b><?php echo f_d($sum_with_nds-($vsego_kvt*17.92));?></b>
 </th>
 ...
 <tr align=center>
<td > Директор филиала ТОО "Солтүстік Энерго Орталық" Айыртау - Энерго </td>
