...
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr>
 <td width=2100px> <?php echo $org->svidetelstvo_nds; ?></td></tr>
 <tr>
 <td width=2100px>Тауарлар (жұмыстар, қызметтер) жеткізуге арналған шарт (келісім-шарт)<br/>Договор(контракт) на поставку товаров (работ, услуг) №<u>   <?php if (strlen($dog2)=='') { echo $firm->dogovor."   </u> от <u>    ".datetostring($firm->dogovor_date);} else {echo $dog2; echo $data_dog2;}?></u></td>
 <td> </td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px>Жүк алушы БСН<br/>Грузополучатель БИН  <u>  <?php if (strlen($firm->edit6)==0) {echo $firm->bin.", ".$firm->name.", ".$firm->address;} else echo $firm->edit6;?>                                                                                                                 </u>   </td>
 <td> </td>
 </tr>
 <tr align=right>
...
<tr align="center">
	...
	<TD width="400px">электроэнергия <?php echo datetostring2($schetfactura_date->date);?> </td>
...
<br />
 ...
 <td align="center"></td>
  ...
  <tr>
 <td align="left"><b>Уполномоченный на подписание счетов-фактур за Руководителя:</b> <?php echo "Зам.Директора Брюханов О.А. "; ?> </td>
 <td></td>
 <td align="right"></td>
 </tr>
  <tr>
 ...
 <tr>
 <td align="left"><b>Упомолномоченный на подписание счетов-фактур<br/>за Гл.Бухгалтера:</b> <?php echo "Инженер по реализации Саблина Т.Н."; ?> </td>
 <td></td>
 <td align="right"></td>
 </tr>
  <tr>
