...
function dob($text)
	...
	function schetfactura()
	{
		...
		$data['data_dog2']=$_POST['data_dog2'];
...
where firm_id={$this->uri->segment(3)} and data_finish is null";
		...
		public function export_rekvizit_schet()
    {
        ...
        if ($db) {
            ...
            if (!copy("c:/oplata/rschet.dbf", "c:/oplata/ayrtau{$month}.dbf")) {
    ...
    public function migration()
    {
        ...
        $this->export_to_excel("other_reports/migration", $data,"уалихановский_рэс");
